"""
Django settings for REST_API_OPTICA project.
...
SECRET_KEY = 'django-insecure-up^qzr@vps#xy#k*hw)no@5w%yaxs-g^$-m&p8b9*n9d0-yy^w'
...
WSGI_APPLICATION = 'REST_API_OPTICA.wsgi.application'
